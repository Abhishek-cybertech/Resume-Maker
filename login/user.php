...
<div class="row">
    ...
    <div id="test2" class="col s12">
     <div class="card">
      <div class="card-title">Graduation Details</div>
   ...
   <div class="col s12">
     <div class="row">
       <div class="input-field col s10">
         ...
         <label for="inst_1">College Name</label>
       </div>
    </div>
       ...
       <div class="col s12">
        <div class="row">
         <div class="input-field col s10">
           ...
           <label for="details_1">Percentage/CGPA</label>
         </div>
       </div>
     </div>
    </div>
  ...
  <div class="card-title">Class XII Details</div>
  <div class ="card content">
   <div class="row">
   <div class="col s12">
     <div class="row">
       <div class="input-field col s10">
         ...
         <label for="inst_2">School Name</label>
       </div>
    </div>
      ...
      <div class="row">
       <div class="input-field col s6">
         ...
         <label for="degree_2">Board</label>
       </div>
       <div class="input-field col s3">
            <i class="material-icons prefix">insert_invitation</i>
       ...
       <div class="col s12">
        <div class="row">
         <div class="input-field col s10">
           ...
           <label for="details_2">Percentage/CGPA</label>
         </div>
       </div>
     </div>
    </div>
          ...
          <div class="col s12">
           <div class="row">
            <div class="input-field col s10">
              ...
              <label for="dt1">Brief of Internship</label>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col s12">
         <div class="row">
          <div class="input-field col s10">
            ...
            <label for="dt2">Internship Details</label>
          </div>
        </div>
      </div>
     </div>
