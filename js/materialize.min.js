...
"undefined" == typeof jQuery &&
              ...
              v.isString(t)
                ...
                : (i =
                    v.isArray(t) && 1 === t.length
                      ...
                      : !(!v.isArray(t) || 4 !== t.length) && l.apply(null, t)),
              !1 === i &&
                (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y),
              i
            );
          }
          function u(t) {
            if (t) {
              ...
              for (var a = 0; i > a; a++)
                if (b.State.calls[a]) {
                  ...
                  for (
                    var g = Math.min((e - h) / c.duration, 1),
                      y = 0,
                      w = l.length;
                    w > y;
                    y++
                    ...
                    if (r(T)) {
                        ...
                        if ("element" !== A) {
                          ...
                          if (((E.currentValue = O), "tween" === A)) m = O;
                            ...
                            var q = k.setPropertyValue(
                              ...
                              A,
                              E.currentValue +
                                (0 === parseFloat(O) ? "" : E.unitType),
                              E.rootPropertyValue,
                              E.scrollData
                            );
                            k.Hooks.registered[A] &&
                              (r(T).rootPropertyValueCache[I] = k.Normalizations
                                .registered[I]
                      ...
                      c.mobileHA &&
                        r(T).transformCache.translate3d === n &&
                        ((r(T).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (S = !0)),
                  ...
                  c.display !== n &&
                    ...
                    c.visibility !== n &&
                      "hidden" !== c.visibility &&
                      (b.State.calls[a][2].visibility = !1),
                    c.progress &&
                      c.progress.call(
                        s[1],
                        s[1],
            ...
            for (
              ...
              if (
                (e ||
                  a.loop ||
                  ("none" === a.display &&
                    k.setPropertyValue(d, "display", a.display),
                  "hidden" === a.visibility &&
                    k.setPropertyValue(d, "visibility", a.visibility)),
                !0 !== a.loop &&
                  (p.queue(d)[1] === n ||
                ...
                p.each(k.Lists.transforms3D, function (t, e) {
                  ...
                  r(d).transformCache[e] !== n &&
                    new RegExp("^\\(" + i + "[^.]").test(o) &&
                    ((h = !0), delete r(d).transformCache[e]);
                }),
                  a.mobileHA &&
                    ((h = !0), delete r(d).transformCache.translate3d),
                  h && k.flushTransformCache(d),
                  k.Values.removeClass(d, "velocity-animating");
              }
              ...
              s && !0 !== a.loop && s(o),
                r(d) &&
                  !0 === a.loop &&
                  !e &&
                  (p.each(r(d).tweensContainer, function (t, e) {
                    /^rotate/.test(t) &&
                  ...
                  b(d, "reverse", { loop: !0, delay: a.delay })),
            ...
            );
          {
            if (!(7 >= h)) {
                    ...
                    for (a = 0; a < k.Lists.colors.length; a++) {
                      var t =
                        "color" === k.Lists.colors[a]
                          ? "0 0 0 1"
                          : "255 255 255 1";
                      k.Hooks.templates[k.Lists.colors[a]] = [
                    ...
                    if (h)
                      for (e in k.Hooks.templates) {
                        ...
                        "Color" === n[0] &&
                          (n.push(n.shift()),
                          o.push(o.shift()),
                          (k.Hooks.templates[e] = [n.join(" "), o.join(" ")]));
                      }
                    for (e in k.Hooks.templates) {
                      n = (i = k.Hooks.templates[e])[0].split(" ");
                      for (var a in n) {
                  ...
                  injectValue: function (t, e, i) {
                    ...
                    if (n) {
                      var o,
                        ...
                        r = n[1];
                      return (
                        (i = k.Hooks.cleanRootPropertyValue(a, i)),
                  ...
                  prefixCheck: function (t) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        v.isString(b.State.prefixElement.style[o]))
                      )
                ...
                getPropertyValue: function (t, i, o, a) {
                        ...
                        if (
                          ...
                          var u =
                            ...
                            (parseFloat(k.getPropertyValue(t, "paddingTop")) ||
                              0) -
                            (parseFloat(
                              k.getPropertyValue(t, "paddingBottom")
                            ) || 0);
                          return o(), u;
                        }
                        if (
                          ...
                          var d =
                            ...
                            (parseFloat(k.getPropertyValue(t, "paddingLeft")) ||
                              0) -
                            (parseFloat(
                              k.getPropertyValue(t, "paddingRight")
                            ) || 0);
                          return o(), d;
                        }
                      }
                  ...
                  if (k.Hooks.registered[i]) {
                    var c = i,
                      u = k.Hooks.getRoot(c);
                    o === n &&
                      (o = k.getPropertyValue(t, k.Names.prefixCheck(u)[0])),
                      k.Normalizations.registered[u] &&
                        (o = k.Normalizations.registered[u]("extract", t, o)),
                      (l = k.Hooks.extractValue(c, o));
                  } else if (k.Normalizations.registered[i]) {
                    var d, f;
                    "transform" !==
                      (d = k.Normalizations.registered[i]("name", t)) &&
                      ((f = s(t, k.Names.prefixCheck(d)[0])),
                      k.Values.isCSSNullValue(f) &&
                        k.Hooks.templates[i] &&
                        (f = k.Hooks.templates[i][1])),
                      (l = k.Normalizations.registered[i]("extract", t, f));
                  }
                  if (!/^[\d-]/.test(l))
                ...
                setPropertyValue: function (t, i, n, o, a) {
                  ...
                  if ("scroll" === i)
                    ...
                    if (
                      ...
                      r(t) && r(t).isSVG && k.Names.SVGAttribute(i)
                        ? t.setAttribute(i, n)
                        : (t.style[s] = n);
                    b.debug >= 2 &&
                ...
                (b.hook = function (t, e, i) {
                  ...
                  return (
                    ...
                    p.each(t, function (t, a) {
                      if ((r(a) === n && b.init(a), i === n))
                        o === n && (o = b.CSS.getPropertyValue(a, e));
                      else {
                ...
                function o() {
                  function t(t) {
                          ...
                          ? ((i = t[0]),
                            ...
                            k.RegEx.isHex.test(t[1])
                              ...
                              : ((v.isString(t[1]) &&
                                  !k.RegEx.isHex.test(t[1])) ||
                                  v.isArray(t[1])) &&
                                ((o = e ? t[1] : c(t[1], s.duration)),
                                t[2] !== n && (r = t[2])))
                          : (i = t),
                        e || (o = o || s.easing),
                        v.isFunction(i) && (i = i.call(a, T, C)),
                        v.isFunction(r) && (r = r.call(a, T, C)),
                        [i || 0, o, r]
                      );
                    }
                    function h(t, e) {
                    ...
                    if ("scroll" === A) {
                      ...
                      s.container
                        ? v.isWrapped(s.container) || v.isNode(s.container)
                          ? ((s.container = s.container[0] || s.container),
                            (g = s.container["scroll" + S]),
                            (x = g + p(a).position()[S.toLowerCase()] + O))
                          : (s.container = null)
                        : ((g =
                            b.State.scrollAnchor[
                              b.State["scrollProperty" + S]
                            ]),
                          (w =
                            b.State.scrollAnchor[
                              b.State[
                      ...
                      if (!r(a).tweensContainer)
                        return void p.dequeue(a, s.queue);
                      "none" === r(a).opts.display &&
                        ...
                        (s = p.extend({}, r(a).opts, s));
                      M = p.extend(!0, {}, r(a).tweensContainer);
                      for (var E in M)
                        if ("element" !== E) {
                          var _ = M[E].startValue;
                          (M[E].startValue = M[E].currentValue = M[E].endValue),
                            (M[E].endValue = _),
                            v.isEmptyObject(y) || (M[E].easing = s.easing),
                            b.debug &&
                              console.log(
                      ...
                      r(a).tweensContainer &&
                        ...
                        p.each(m, function (t, e) {
                          if (
                            RegExp("^" + k.Lists.colors.join("$|^") + "$").test(
                              t
                            )
                          ) {
                            var i = d(e, !0),
                      ...
                      for (var q in m) {
                        ...
                        if (
                          r(a).isSVG ||
                          "tween" === j ||
                          !1 !== k.Names.prefixCheck(j)[1] ||
                          k.Normalizations.registered[j] !== n
                        ) {
                          ((s.display !== n &&
                            null !== s.display &&
                            "none" !== s.display) ||
                            (s.visibility !== n &&
                              "hidden" !== s.visibility)) &&
                            /opacity|filter/.test(q) &&
                            !L &&
                            0 !== V &&
                            (L = 0),
                            s._cacheValues && M && M[q]
                              ? (L === n && (L = M[q].endValue + M[q].unitType),
                                ($ = r(a).rootPropertyValueCache[j]))
                              : k.Hooks.registered[q]
                              ? L === n
                                ? (($ = k.getPropertyValue(a, j)),
                                  (L = k.getPropertyValue(a, q, $)))
                                : ($ = k.Hooks.templates[j][1])
                              : L === n && (L = k.getPropertyValue(a, q));
                          var N,
                            W,
                            F,
                            Q = !1;
                          if (
                            ...
                            (V = parseFloat(V) || 0),
                            "%" === W &&
                              (/^(fontSize|lineHeight)$/.test(q)
                                ? ((V /= 100), (W = "em"))
                                : /^scale/.test(q)
                                ? ((V /= 100), (W = ""))
                                : /(Red|Green|Blue)$/i.test(q) &&
                                  ((V = (V / 100) * 255), (W = ""))),
                            /[\/*]/.test(Q))
                          )
                            W = F;
                              ...
                              o =
                                ...
                                (function () {
                                  var t = {
                                    ...
                                    n =
                                      t.position === I.lastPosition &&
                                      t.myParent === I.lastParent,
                                  ...
                                  if (o && n)
                                    ...
                                    b.init(c),
                                      ...
                                      (l.emToPx = I.lastEmToPx =
                                        (parseFloat(
                                          k.getPropertyValue(c, "paddingLeft")
                                        ) || 1) / s),
                    ...
                    l.element &&
                      ...
                      D.push(l),
                      "" === s.queue &&
                        ((r(a).tweensContainer = l), (r(a).opts = s)),
                      (r(a).isAnimating = !0),
                      T === C - 1
                        ? (b.State.calls.push([D, f, s, null, P.resolver]),
                          !1 === b.State.isTicking &&
                  ...
                  !1 !== b.mock &&
                    ...
                    s.display !== n &&
                      ...
                      "auto" === s.display &&
                        (s.display = b.CSS.Values.getDisplayType(a))),
                    s.visibility !== n &&
                      null !== s.visibility &&
                    ...
                    !1 === s.queue
                      ? s.delay
                        ...
                        : t()
                      : p.queue(a, s.queue, function (e, i) {
                          return !0 === i
                            ? (P.promise && P.resolver(f), !0)
                            : ((b.velocityQueueEntryFlag = !0), void t(e));
                        }),
                    ("" !== s.queue && "fx" !== s.queue) ||
                ...
                if (
                  ...
                  switch (m) {
                    ...
                    case "stop":
                      ...
                      var O = [];
                      return (
                        p.each(b.State.calls, function (t, e) {
                          e &&
                      ...
                      if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                        if (v.isString(m) && b.Redirects[m]) {
                          ...
                          return (
                            ...
                            p.each(f, function (t, e) {
                              parseFloat(z.stagger)
                                ? (z.delay = _ + parseFloat(z.stagger) * t)
                                : v.isFunction(z.stagger) &&
                                  (z.delay = _ + z.stagger.call(e, t, C)),
                                z.drag &&
                                  ((z.duration =
                                    parseFloat(E) ||
                        ...
                        return (
                          P.promise ? P.rejecter(new Error(M)) : console.log(M),
                          t()
                        );
                      }
                      A = "start";
                  ...
                  if (
                    ((z.loop = parseInt(z.loop)), (q = 2 * z.loop - 1), z.loop)
                  )
                    for (var V = 0; q > V; V++) {
              ...
              return (
                ...
                (t.Velocity = b),
                t !== e &&
                  ((t.fn.velocity = x), (t.fn.velocity.defaults = b.defaults)),
  ...
  (function (t, e, i, n) {
    ...
    function k(t, e) {
      for (
        var i, o, a = e[0].toUpperCase() + e.slice(1), r = 0;
        r < lt.length;
    ...
    (Y.prototype = {
      ...
      recognize: function (t) {
        ...
        return d(this.options.enable, [this, e])
          ? (this.state & (re | se | 32) && (this.state = ie),
            ...
            void (this.state & (ne | oe | ae | se) && this.tryEmit(e)))
      ...
      c(tt, Y, {
        ...
        process: function (t) {
          ...
          if (((this._input = t), !n || !i || (t.eventType & (Tt | St) && !a)))
            this.reset();
          ...
          for (var a = 0; a < n.length; )
            (i = n[a]),
              2 === e.stopped || (o && i != o && !i.canRecognizeWith(o))
                ? i.reset()
                : i.recognize(t),
              !o && i.state & (ne | oe | ae) && (o = e.curRecognizer = i),
              a++;
        }
      },
      get: function (t) {
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
        ...
        this.each(function () {
          function n(e) {
            (p = d.find("> li > .collapsible-header")),
              ...
              p.not(e).removeClass("active").parent().removeClass("active"),
              p
                .not(e)
                .parent()
          ...
          function r(t, i) {
            i || t.toggleClass("active"),
              e.accordion || "accordion" === h || void 0 === h ? n(t) : a(t),
              s(t);
          }
          function s(t) {
            t.hasClass("active")
              ...
              function n() {
                void 0 !== r.data("induration") &&
                  ...
                  void 0 !== r.data("outduration") &&
                    (s.outDuration = r.data("outduration")),
                  void 0 !== r.data("constrainwidth") &&
                    (s.constrainWidth = r.data("constrainwidth")),
                  void 0 !== r.data("hover") && (s.hover = r.data("hover")),
                  void 0 !== r.data("gutter") && (s.gutter = r.data("gutter")),
                  void 0 !== r.data("beloworigin") &&
                    (s.belowOrigin = r.data("beloworigin")),
                  void 0 !== r.data("alignment") &&
                    (s.alignment = r.data("alignment")),
                  void 0 !== r.data("stoppropagation") &&
                    (s.stopPropagation = r.data("stoppropagation"));
              }
              function o(e) {
                "focus" === e && (l = !0),
                  n(),
                ...
                if (
                  ...
                  d + c.innerWidth() > t(window).width()
                    ? (h = "right")
                    : d - c.innerWidth() + r.innerWidth() < 0 && (h = "left"),
                  p + c.innerHeight() > o)
                )
                ...
                "left" === h
                  ? ((f = s.gutter), (v = r.position().left + f))
                  : "right" === h &&
                    (c.stop(!0, !0).css({ opacity: 0, left: 0 }),
                    (v = r.position().left + i - c.width() + (f = -s.gutter))),
                  c.css({
                    position: "absolute",
              ...
              if ((n(), r.after(c), s.hover)) {
                ...
                r.off("click." + r.attr("id")),
                  ...
                  r.on("mouseleave", function (e) {
                    ...
                    t(i).closest(".dropdown-content").is(c) ||
                      (c.stop(!0, !0), a(), (u = !1));
                  }),
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var n = {
                    ...
                    ease: "easeOutCubic",
                    complete: function () {
                      "function" == typeof i.options.ready &&
                        i.options.ready.call(i, i.$el, i.openingTrigger);
                    },
                  };
                  this.$el[0].classList.contains("bottom-sheet")
                    ? e(this.$el[0], { bottom: 0, opacity: 1 }, n)
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.$el[0].classList.contains("bottom-sheet")
                    ? e(this.$el[0], { bottom: "-100%", opacity: 0 }, i)
                    : e(
                        this.$el[0],
                        {
      ...
      return this.each(function (i) {
        function n(i) {
          ...
          i && a.css("display", "block"),
            s > c &&
              l < c + u &&
              a.css("transform", "translate3D(-50%," + p + "px, 0)");
        }
        var o = t(this);
        o.addClass("parallax"),
          o
      ...
      init: function (e) {
        ...
        return this.each(function (i) {
          ...
          e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1),
            0 === (o = t(p.filter('[href="' + location.hash + '"]'))).length &&
              (o = t(this).find("li.tab a.active").first()),
            0 === o.length && (o = t(this).find("li.tab a").first()),
            o.addClass("active"),
            (m = p.index(o)) < 0 && (m = 0),
            void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"),
            ...
            e.swipeable
              ? (p.each(function () {
                ...
                (r = f.wrapAll('<div class="tabs-content carousel"></div>')),
                f.css("display", ""),
          ...
          this.each(function () {
            ...
            (c = (function () {
              ...
              return (
                ...
                (u = t('<div class="backdrop"></div>')).appendTo(e),
                e
              );
            })()),
                ...
                p = setTimeout(function () {
                  ...
                  "top" === s
                    ...
                    : ((t = o.offset().top + o.outerHeight() + 5),
                      ...
                      (n = e(i, t, p, l)),
                      (f = "+10px"),
                      u.css({ top: 0, left: 0, marginLeft: p / 2 - m / 2 })),
        ...
        function n(e, i, o, a) {
          if ((_classCallCheck(this, n), e)) {
            (this.options = {
              ...
              (this.options = t.extend({}, n.defaults, this.options)),
              (this.message = e),
              (this.panning = !1),
        ...
        (e = t.extend(i, e)),
          t(this).each(function () {
            ...
            e.draggable
              ...
              : (a = t()),
              "left" == e.edge
                ? (o.css("transform", "translateX(-100%)"), a.css({ left: 0 }))
                : (o
                ...
                .on("pan", function (i) {
                  if ("touch" == i.gesture.pointerType) {
                    ...
                    "left" === e.edge
                      ...
                      : ((p = Math.abs((n - window.innerWidth) / e.menuWidth)),
                        c.velocity(
                          { opacity: p },
                          { duration: 10, queue: !1, easing: "easeOutQuad" }
                        ));
        ...
        function i(t, e, i) {
          ...
          return (
            ...
            i
              ...
              .eq(e)
              .toggleClass("active"),
            i.find("option").eq(e).prop("selected", a),
            n(t, i),
            a
          );
        }
          ...
          this.each(function () {
            ...
            function n(t) {
              t >= c.length ? (t = 0) : t < 0 && (t = c.length - 1),
                (u = l.find(".active").index()) != t &&
                  ...
                  e.indicators && a.eq(u).removeClass("active"),
                  c
                    .eq(t)
                    .velocity(
                      { opacity: 1 },
            ...
            -1 != u && (o = c.eq(u)),
              s.hasClass("fullscreen") ||
                (e.indicators ? s.height(e.height + 40) : s.height(e.height),
                l.height(e.height)),
              ...
              e.indicators &&
                ...
                s.append(a),
                (a = s.find("ul.indicators").find("li.indicator-item"))),
              o
                ? o.show()
                : (c
                    .first()
              ...
              .on("pan", function (t) {
                if ("touch" === t.gesture.pointerType) {
                  ...
                  ($curr_slide = l.find(".active")),
                    ...
                    4 === e && (i > s.innerWidth() / 2 || n < -0.65)
                      ? (h = !0)
                      : 2 === e &&
                        (i < (-1 * s.innerWidth()) / 2 || n > 0.65) &&
                        (p = !0);
                  var a;
                  p &&
                    (0 === (a = $curr_slide.next()).length && (a = c.first()),
                    a.velocity(
                      { opacity: 1 },
                      { duration: 300, queue: !1, easing: "easeOutQuad" }
                    )),
                    h &&
                      (0 === (a = $curr_slide.prev()).length && (a = c.last()),
                      a.velocity(
                        { opacity: 1 },
                        { duration: 300, queue: !1, easing: "easeOutQuad" }
                      ));
      ...
      (t.fn.material_chip = function (i) {
        ...
        (n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data)),
              ...
              n.$document
                ...
                .on("keydown.chips-add", e.CHIPS + " " + e.INPUT, function (i) {
                  ...
                  if (13 === i.which) {
                    if (
                      n.hasAutocomplete &&
                      a.find(".autocomplete-content.dropdown-content").length &&
                      a
                  ...
                  if (
                    ...
                    return (
                      i.preventDefault(), n.selectChip(r - 1, a), void o.blur()
                    );
                }),
              n.$document
          ...
          (this.addChip = function (t, e) {
            if (n.isValid(e, t)) {
              for (
                var i = n.renderChip(t), o = [], a = e.data("chips"), r = 0;
                r < a.length;
                r++
              )
                o.push(a[r]);
          ...
          t(this)
            ...
            .on("pan", function (n) {
              if ("touch" === n.gesture.pointerType) {
                ...
                o.velocity(
                  ...
                  4 === a && (r > o.innerWidth() / 2 || s < -0.75) && (e = !0),
                  2 === a &&
                    (r < (-1 * o.innerWidth()) / 2 || s > 0.75) &&
                    (i = !0);
              }
            })
            .on("panend", function (n) {
              if (
                ...
                if (e || i) {
                  var a;
                  (a = e ? o.innerWidth() : -1 * o.innerWidth()),
                    o.velocity(
                      { translateX: a },
                      {
                        duration: 100,
    ...
    Materialize.scrollFire = function (t) {
      var i = function () {
          for (
            ...
            null !== s &&
              e > s.getBoundingClientRect().top + window.pageYOffset + a &&
              !0 !== n.done &&
              ("function" == typeof r
                ? r.call(this, s)
  ...
  (function (t) {
    ...
    function e(a, s, u, d) {
      ...
      function h() {
        x
          ...
          w.editable ||
            x
              .on("focus." + b.id + " click." + b.id, function (t) {
            ...
            function () {
              ...
              (o = o && (o.type || o.href) && o),
                (n || (o && !t.contains(T.$root[0], o))) &&
                  T.$root.eq(0).focus(),
                !n && i.nav
                  ? T.set("highlight", T.component.item.highlight, {
                      nav: i.nav,
                    })
                  : !n && "pick" in i
                  ? (T.set("select", i.pick), w.closeOnSelect && T.close(!0))
                  : i.clear
                  ? (T.clear(), w.closeOnSelect && T.close(!0))
                  : i.close && T.close(!0);
            }
          ),
          o(T.$root[0], "hidden", !0);
      ...
      function v() {
        ...
        !0 === w.hiddenName
          ...
          : (e =
              (e = [
                "string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "",
                "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit",
              ])[0] +
              a.name +
              e[1]),
          (T._hidden = t(
            '<input type=hidden name="' +
              ...
              (x.data("value") || a.value
                ? ' value="' + T.get("select", w.formatSubmit) + '"'
                : "") +
              ">"
          )[0]),
        ...
        T = (C.prototype = {
          ...
          render: function (t) {
            return (
              t
                ? T.$root.html(p())
                : T.$root.find("." + k.box).html(T.component.nodes(b.open)),
              T.trigger("render")
            );
          },
          stop: function () {
            return b.start
              ? (T.close(),
                T._hidden && T._hidden.parentNode.removeChild(T._hidden),
                T.$root.remove(),
            ...
            return b.open
              ...
              : (x.addClass(k.active),
                ...
                !1 !== i &&
                  ...
                  T.$root.eq(0).focus(),
                  l
                    .on("click." + b.id + " focusin." + b.id, function (t) {
                      var e = t.target;
                      e != a &&
                        e != document &&
                        3 != t.which &&
                        T.close(e === T.$root.children()[0]);
                    })
                    .on("keydown." + b.id, function (i) {
                      ...
                      27 == n
                        ? T.close(!0)
                        : a != T.$root[0] || (!o && 13 != n)
                        ? t.contains(T.$root[0], a) &&
                          13 == n &&
                          (i.preventDefault(), a.click())
                        : (i.preventDefault(),
                          o
                            ? e._.trigger(T.component.key.go, T, [
                                e._.trigger(o),
                              ])
                            : T.$root
                                .find("." + k.highlighted)
                                .hasClass(k.disabled) ||
                              (T.set("select", T.component.item.highlight),
          ...
          close: function (t) {
            return (
              t &&
                (T.$root.off("focus.toOpen").eq(0).focus(),
                setTimeout(function () {
              ...
              for (o in s)
                (a = s[o]),
                  o in T.component.item &&
                    (void 0 === a && (a = null), T.component.set(o, a, n)),
                  ("select" != o && "clear" != o) ||
                    x
                      .val("clear" == o ? "" : T.get(o, w.format))
                      .trigger("change");
              T.render();
            }
          ...
          get: function (t, i) {
            ...
            if (t in T.component.item) {
              if ("string" == typeof i) {
                ...
                return n
                  ? e._.trigger(T.component.formats.toString, T.component, [
                      i,
                      n,
                    ])
                  : "";
    ...
    function o(e, i, n) {
      if (t.isPlainObject(i)) for (var o in i) a(e, o, i[o]);
      else a(e, i, n);
    }
    function a(t, e, i) {
    ...
    (i.prototype.set = function (t, e, i) {
      ...
      (i.prototype.nodes = function (t) {
        var e = this,
          ...
          p = (function (t, e) {
            return (
              i.firstDay && (t.push(t.shift()), e.push(e.shift())),
              n.node(
                "thead",
                n.node(
                  "tr",
          ...
          h = function (t) {
            return n.node(
              ...
              i.klass["nav" + (t ? "Next" : "Prev")] +
                ((t && l.year >= d.year && l.month >= d.month) ||
            ...
            return (
              ...
              i.selectMonths && void 0 == o
                ? n.node(
                      ...
                      item: function (t) {
                        return [
                          ...
                          "value=" +
                            t +
                            (l.month == t ? " selected" : "") +
                            ((l.year == u.year && t < u.month) ||
                            (l.year == d.year && t > d.month)
                              ? " disabled"
                              : ""),
                        ];
                      },
                    ...
                    (t ? "" : "disabled") +
                      " " +
                      n.ariaAttr({ controls: e.$node[0].id + "_table" }) +
                      ' title="' +
                      i.labelMonthSelect +
                      '"'
                  )
        ...
        return (
          ...
          n.node(
            ...
            n.node("div", v("raw"), i.klass.year_display) +
              ...
              n.node("span", f("short_months") + " ", i.klass.month_display) +
              n.node("span", createDayLabel(), i.klass.day_display),
                      ...
                      n.node(
                        ...
                        n.group({
                          ...
                          item: function (t) {
                            var o =
                              i.firstDay &&
                              0 === e.create([l.year, l.month, 1]).day
                                ? -7
                                : 0;
                            return [
                              n.group({
                                ...
                                item: function (t) {
                                  ...
                                  var o = r && r.pick == t.pick,
                                    ...
                                    h =
                                      ...
                                      t.pick < u.pick ||
                                      t.pick > d.pick,
                                    f = n.trigger(e.formats.toString, e, [
                                      i.format,
                                      t,
                                    ]);
                                  return [
                                    n.node(
                                      ...
                                      (function (e) {
                                        return (
                                          ...
                                          a.pick == t.pick &&
                                            e.push(i.klass.now),
                                          o && e.push(i.klass.selected),
                                          p && e.push(i.klass.highlighted),
                                          h && e.push(i.klass.disabled),
                                          e.join(" ")
                                        );
                                      })([i.klass.day]),
                                      "data-pick=" +
                ...
                n.node(
                  ...
                  n.node(
                    ...
                    "type=button data-pick=" +
                      ...
                      " " +
                      n.ariaAttr({ controls: e.$node[0].id })
                  ) +
                    n.node(
                      "button",
                      i.clear,
  ...
  (function (t) {
    ...
    function o(o, r) {
            ...
            s.off(f).on(f, function (t) {
              ...
              (e || p) && n === l && u === c && E.setHand(n, u),
                "hours" === E.currentView
                  ...
                  : r.autoclose &&
                    (E.minutesView.addClass("clockpicker-dial-out"),
                    setTimeout(function () {
                      E.done();
                    }, x / 2)),
                d.prepend(z),
      ...
      (this.id = n("cp")),
        ...
        A.on("focus.clockpicker click.clockpicker", t.proxy(this.show, this));
      var _,
        M,
        I,
        D,
        ...
        if (!this.isShown) {
          ...
          this.toggleView("hours"),
            ...
            s.on(
              ...
              function (e) {
                var i = t(e.target);
                0 === i.closest(n.popover.find(".picker__wrap")).length &&
        ...
        return this.each(function (i) {
          ...
          function s(i) {
            ...
            if (
              ...
              e.fullWidth
                ? (u = "translateX(0)")
                : ((u = "translateX(" + (j[0].clientWidth - m) / 2 + "px) "),
                  (u += "translateY(" + (j[0].clientHeight - g) / 2 + "px)")),
              N)
            ) {
              var p = w % C,
              ...
              h.index() !== p &&
                ...
                V.find(".indicator-item").eq(p).addClass("active"));
            }
            for (
              (!W || (w >= 0 && w < C)) &&
                ((c = v[r(w)]),
                t(c).hasClass("active") ||
                  (j.find(".carousel-item").removeClass("active"),
                  t(c).addClass("active")),
                (c.style[_] =
                  u +
                  " translateX(" +
              ...
              e.fullWidth
                ? ((zTranslation = e.dist),
                  (tweenedOpacity = n === o && a < 0 ? 1 - l : 1))
                : ((zTranslation = e.dist * (2 * n + l * s)),
                  (tweenedOpacity = 1 - 0.2 * (2 * n + l * s))),
                (!W || w + n < C) &&
                  (((c = v[r(w + n)]).style[_] =
                    u +
                    " translateX(" +
          ...
          if (
            (e.fullWidth &&
              ((e.dist = 0),
              Q(),
              N && j.find(".carousel-fixed-item").addClass("with-indicators")),
            j.hasClass("initialized"))
          )
            return (
              t(window).trigger("resize"), j.trigger("carouselNext", [1e-6]), !0
            );
          j.addClass("initialized"),
            ...
            (g = j.find(".carousel-item").first().innerHeight()),
            (x = 2 * m + e.padding),
          ...
          t(window)
            ...
            t(this).on("carouselNext", function (t, e, i) {
              void 0 === e && (e = 1),
                ...
                b !== A &&
                  ((P = A - b), (I = Date.now()), requestAnimationFrame(c));
            }),
      ...
      init: function (e) {
        return this.each(function () {
          ...
          o.length ||
            ...
            s.length ||
              ((s = t('<div class="tap-target-content"></div>')), n.append(s)),
            a.length ||
              ((a = t('<div class="tap-target-wave"></div>')),
              r.length ||
                ((r = i.clone(!0, !0)).addClass("tap-target-origin"),
                r.removeAttr("id"),
                r.removeAttr("style"),
                a.append(r)),
              o.append(a));
